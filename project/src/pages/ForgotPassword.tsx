        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4">
              <Link
                to="/auth"
                className="w-full bg-black text-white py-3 px-4 rounded-lg font-medium hover:bg-[#337AFF] transition-colors inline-block"
              >
                Back to Sign In
              </Link>
              <button
      ...
      >
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mt-6 text-center">
            <Link
              to="/auth"
              className="inline-flex items-center space-x-2 text-sm text-[#337AFF] hover:text-blue-700 transition-colors"
            >
              <ArrowLeft size={16} />
