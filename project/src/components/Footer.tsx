        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Premium black and white essentials. One collection per month.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/verify" className="text-gray-400 hover:text-white transition-colors">Verify SKU</Link></li>
